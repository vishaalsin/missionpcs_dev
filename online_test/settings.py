...
SECRET_KEY = config('SECRET_KEY', default='dUmMy_k3y')
...
DATABASES = {
    'default': {
        ...
        'USER': 'postgres',
        'PASSWORD': 'Bs145tu@12345'#'shivam20',
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
...
rzp_key_prod = 'XXXXXXXXXXXXXXXXXXXXXXXXX'
rzp_secret_key_prod = 'XXXXXXXXXXXXXXXXXXXXXXXXX'

twilio_number = 'XXXXXXXXXXXXXXXXXXXXXXXXX'
