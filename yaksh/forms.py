...
class TestSeriesForm(forms.Form):
    def __init__(self, user, *args, **kwargs):
        ...
        self.fields['test1'] = forms.CharField(label='Select test 1 :', initial='NONE', required=False, widget=forms.Select(attrs={'class': 'form-control'}, choices=self.quizzes + [('NONE', 'NONE')]))
        self.fields['test_date1'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'class': 'form-control'}))
        self.fields['test2'] = forms.CharField(label='Select test 2 :', initial='NONE', required=False, widget=forms.Select(attrs={'class': 'form-control'}, choices=self.quizzes + [('NONE', 'NONE')]))
        self.fields['test_date2'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'class': 'form-control'}))
        self.fields['test3'] = forms.CharField(label='Select test 3 :', initial='NONE', required=False, widget=forms.Select(attrs={'class': 'form-control'}, choices=self.quizzes + [('NONE', 'NONE')]))
        self.fields['test_date3'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'class': 'form-control'}))
        self.fields['test4'] = forms.CharField(label='Select test 4 :', initial='NONE', required=False, widget=forms.Select(attrs={'class': 'form-control'}, choices=self.quizzes + [('NONE', 'NONE')]))
        self.fields['test_date4'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'class': 'form-control'}))
        self.fields['test5'] = forms.CharField(label='Select test 5 :', initial='NONE', required=False, widget=forms.Select(attrs={'class': 'form-control'}, choices=self.quizzes + [('NONE', 'NONE')]))
        self.fields['test_date5'] = forms.DateField(widget=forms.SelectDateWidget(attrs={'class': 'form-control'}))
    class Meta:
        model = Test_Series
